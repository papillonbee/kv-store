...
/**
 * KvService — in-memory, per-key-atomic KV store with optional WAL+snapshot
...
public class KvService {
    ...
    public KvService(Persistence persistence) {
        this(persistence != null ? persistence.recoveredState() : Map.of(), persistence);
    }

    private KvService(Map<String, KvEntry> initialState, Persistence persistence) {
