...
public class KvStoreApplication {
    ...
    public KvStore kvStore(
        ...
        KvStore kvStore = (persistence == null) ? new KvStore() : new KvStore(persistence);
        if (persistence != null) {
            persistence.schedulePeriodicSnapshots(kvStore::snapshotState, Duration.ofSeconds(snapshotIntervalSeconds));
        }
        return kvStore;
    }
